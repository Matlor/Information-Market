		...
		<>
			{isConnected ? (
				<div className="flex flex-col gap-[20px]">
					...
					<div className="flex flex-col gap-[3px] items-center text-normal">
						<input
							type="text"
							className="w-30  p-2.5 text-center outline-none placeholder:text-normal rounded-md shadow-md bg-colorBackgroundComponents border-none"
				...
				<div className="text-normal">Not connected</div>
			)}
		</>
	);
};
