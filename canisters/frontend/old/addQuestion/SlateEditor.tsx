...
// timeLeft={<TimeLeft minutes={question.status_end_date} />}
const SlateEditor = ({ inputValue, setInputValue, placeholder, timeLeft }) => {
	...
	return (
		<div
			className="h-full flex flex-col gap-[37px] p-content items-star"
			data-cy="SlateEditor"
		>
			...
			>
				...
				>
					...
					{/* overflow-y-scroll scrollbar -> this looked weird when pressing list without anything in there.  */}
					{/* maybe could just be styled though. */}
					<Editable
