...
// #region ICP Transfer
  ...
  public type Interface = actor {
    accountIdentifierToBlob: (AccountIdentifier) -> async AccountIdentifierToBlobResult;
    create_invoice: (CreateInvoiceArgs) -> async CreateInvoiceResult;
    get_account_identifier: (GetAccountIdentifierArgs) -> async GetAccountIdentifierResult;
    get_balance: (GetBalanceArgs) -> async GetBalanceResult;
    get_invoice: (GetInvoiceArgs) -> async GetInvoiceResult;
    transfer: (TransferArgs) -> async TransferResult;
    verify_invoice: (VerifyInvoiceArgs) -> async VerifyInvoiceResult;
  };
// #endregion
};
